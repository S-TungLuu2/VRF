...
import { colorLinkFunc, colorRectFunc, formatLinkTitleFunc, formatRectTitleFunc, makeSankeyFunc } from './parse';
...
export const SankeyChart = ({ width, height }: SankeyChartProps): JSX.Element | null => {
  ...
  return (
    <svg width={width} height={height}>
      <SankeyRects nodes={nodes} colorFunc={colorRectFunc} titleFunc={formatRectTitleFunc} />
      <SankeyLinks links={links} colorFunc={colorLinkFunc} titleFunc={formatLinkTitleFunc} />
...
export const Sankey = (): JSX.Element => {
  ...
  return (
    ...
    <div ref={ref}>{width > 0 && <SankeyChart width={width} height={600} />}</div>
  );
};
